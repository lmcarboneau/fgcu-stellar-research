function [mask_grow,masksize,aperture] = find_masksize(mean_image,count_sort,series,time,apdim,dim,n,x1, y1)
...
while (loop_count < n)
    % every pixel (except all brighter than our target) in the mean image
    % in order of greatest adjacent flux
...
masksize = 40; % just a baseline to start with
