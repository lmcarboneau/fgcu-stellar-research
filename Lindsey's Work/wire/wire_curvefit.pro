...
;         yfit=wire_curvefit(x,y,Weights,a,sigma,function_name='gfunct')
...
;
;-
FUNCTION WIRE_CURVEFIT, x, y, weightsIn, a, sigma, FUNCTION_NAME = Function_Name, $
    FITA=fita, $
...
; HB WIRE change:
            IF (N_ELEMENTS(yfit) NE nY) THEN BEGIN ;MESSAGE, error_msg1
               yfit = 'Failed wire_curvefit.pro'
               goto,fail_curvefit
            endif
          ENDELSE
