; Compare simulations of Alpha Cen with WIRE data
...
datamode = 'NA' ; not computed by Hans K yet
...
fmax = 5700. ; freq. max in c/day max is about 5700
; Nykvist frekens: 1/delta_t(point to point) = 1e6/(11.57*15) c/d

nmax = 800000L ; 140000L ; 500000L
...
readcol,w9+'/wire_lc/wire_lc_alphaCen'+epoch2+'_star_0.dat',tt2,dat2,wei2
...
; Read Hans K's simulation + compute ampl. spectrum
if epoch eq '1999' or epoch eq '2004' and datamode ne 'NA' then begin
...
if epoch eq '2004' then sigma = 0.000224
if epoch eq '1999' then sigma = 0.000110 ; from ptp sigma!
...
endif ; are Hans K's simulations available?

; ================== FINAL PLOTS =============================

ff= 35 ; smooth factor

outps = '~/wire/wire_eps/wire_acen_'+epoch+'.ps'
...
outsave = $
 '/ai40/bruntt/wire/wire_simul/wire_granul_acen_'+epoch+'_'+batch+datamode+'.idl'
